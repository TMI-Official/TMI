...
(function($) {
  ...
  $(document).ready(function() {
    ...
    if( $('.mfn-go-to').length ){
      $(document).on('click', '.mfn-go-to', function(e) {
        ...
        if( target == 'last' ){
          ...
          if( !$(this).closest('.section').prev('.section').length ) {console.error('TMI: Prev section doesnt exists'); return; }
          offset = $(this).closest('.section').prev('.section').offset().top;
        }else{
          if( !$(this).closest('.section').next('.section').length ) {console.error('TMI: Next section doesnt exists'); return; }
    ...
    */
    ...
    /**
     * Widget | TMI Menu | Hover on click
     */
